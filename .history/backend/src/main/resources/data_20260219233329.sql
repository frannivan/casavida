-- FINAL ATTEMPT AT DATA INITIALIZATION

-- 1. Roles with fixed IDs
...
-- 4. Manual Junction Table Inserts (No SELECTs to avoid complexity)
-- Admin (id 1) -> ROLE_ADMIN (id 2)
INSERT INTO user_roles (user_id, role_id) VALUES (1, 2);
-- Admin (id 1) -> ROLE_USER (id 1)
