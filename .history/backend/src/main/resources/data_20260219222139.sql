-- Clear data in order to respect foreign keys
...
-- Ensure roles (H2/Postgres compatible check)
-- Spring Boot will handle inserts below
...
INSERT INTO users (id, username, email, password) VALUES (7, 'cliente_test', 'cliente@test.com', '$2a$10$qbVHd72aWuXZTIrAm75aIud8plhMfJKbdps00KbjmqDrniX4bcpou');
INSERT INTO users (id, username, email, password) VALUES (101, 'franivan@test.com', 'franivan@test.com', '$2a$10$qbVHd72aWuXZTIrAm75aIud8plhMfJKbdps00KbjmqDrniX4bcpou');
INSERT INTO users (id, username, email, password) VALUES (102, 'maria@test.com', 'maria@test.com', '$2a$10$qbVHd72aWuXZTIrAm75aIud8plhMfJKbdps00KbjmqDrniX4bcpou');
...
-- 6. Clientes (Linked to Users 101, 102)
