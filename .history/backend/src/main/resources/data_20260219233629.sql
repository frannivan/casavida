...
-- 3. Link Roles (EXACTLY ONE PER USER)
INSERT INTO user_roles (user_id, role_id) VALUES (1, 2);   -- Admin -> Admin ONLY
INSERT INTO user_roles (user_id, role_id) VALUES (2, 3);   -- Vendedor -> Vendedor
INSERT INTO user_roles (user_id, role_id) VALUES (3, 4);   -- Recepcion -> Recepcion
INSERT INTO user_roles (user_id, role_id) VALUES (101, 1); -- Franivan -> User
INSERT INTO user_roles (user_id, role_id) VALUES (102, 1); -- Maria -> User
