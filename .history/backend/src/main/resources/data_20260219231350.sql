-- DATA INITIALIZATION (REDUNDANT & ROBUST)

-- 1. Roles (Ensure IDs are fixed)
...
-- 2. Delete and recreate main users to avoid ID shift or role pollution
...
-- 3. Link Roles (Admin ID 1 -> ROLE_ADMIN ID 2)
INSERT INTO user_roles (user_id, role_id) VALUES 
(1, 2), (1, 1), -- Admin gets both roles for compatibility
(2, 3), 
(3, 4), 
(4, 2), 
(101, 1), 
