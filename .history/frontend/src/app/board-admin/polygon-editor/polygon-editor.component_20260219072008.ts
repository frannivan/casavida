...
export class PolygonEditorComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    saveFraccionamientoPolygon(): void {
        console.log("DEBUG: saveFraccionamientoPolygon called. currentPoints:", this.currentPoints.length);
    ...
    saveLotePolygon(): void {
        console.log("DEBUG: saveLotePolygon called. currentPoints:", this.currentPoints.length);
